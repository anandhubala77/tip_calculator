function calculateTip() {
  ...
  function reset() {
    ...
    document.querySelector("#tipAmount").innerHTML = "<i class=\"fa-solid fa-rupee-sign\"></i> 0.00";
    document.querySelector("#totalBill").innerHTML = "<i class=\"fa-solid fa-rupee-sign\"></i> 0.00";
  }
